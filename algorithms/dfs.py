...
def dfs(grid, start, end, lines, columns):
  #cria uma fila
  q = queue.LifoQueue() 
...
def main():
  ...
  #le o labirinto
  maze = readMaze("maze6.txt")
  #realiza a busca retornando o caminho
  path, visited = dfs(maze.grid, (maze.startI, maze.startJ), (maze.endI, maze.endJ), maze.lines, maze.columns)
